...
import interfaces.User_Operations_Interface;
import model.UserPojo;

public class User_Operations implements User_Operations_Interface {
    ...
    public boolean deleteUserByMail(String mailID) {
    ...
    public UserPojo fetchUserByMail(String mailID) {

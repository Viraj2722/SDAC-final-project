...
if (request.getParameter("deleteFeedback") != null) {
	...
	try {
		...
		String verifyQuery = "SELECT f.FeedbackID FROM feedback f " + "JOIN customers c ON f.CustomerID = c.CustomerID "
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item"><a class="nav-link" href="homepage.jsp">
							<i class="fas fa-home"></i> Home
					</a></li>
					<li class="nav-item"><a class="nav-link" href="#"> <i
							class="fas fa-user"></i> <%=userEmail%>
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="orderhistory.jsp"> <i class="fas fa-history"></i> Order
							History
					</a></li>
	...
	<div class="container my-5">
		...
		<div class="alert alert-success alert-dismissible fade show"
			role="alert">
			<i class="fas fa-check-circle me-2"></i> Feedback has been
		...
		<div class="row g-4">
			...
			try {
				...
				if (customerRs.next()) {
					...
					+ "JOIN products p ON f.ProductID = p.ProductID " + "WHERE f.CustomerID = ? "
			...
			<div class="col-12">
				<div class="alert alert-info" role="alert">
					<i class="fas fa-info-circle me-2"></i> You haven't provided any
					feedback yet. When you rate products, they will appear here!
				</div>
			</div>
			<%
			}
				...
				<div class="card feedback-card h-100">
					<div class="card-body">
						...
						<div class="mb-2">
							...
							%>
							<i
								class="fas fa-star star-rating <%=i <= rs.getInt("Rating") ? "" : "text-secondary"%>"></i>
							<%
							}
							%>
						</div>
						...
						<div class="d-flex justify-content-between align-items-center">
							<a href="productpage.jsp?productId=<%=rs.getInt("ProductID")%>"
								...
								class="fas fa-external-link-alt me-1"></i> View Product
							</a>
